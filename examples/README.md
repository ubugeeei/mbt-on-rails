...
- `examples/orm_migration`
  - Shows model schema design, relation SQL generation, in-memory relation execution, create-table migrations, phased migration plans, typed attribute casting/serialization, safety summaries, and the in-memory validation flow.
