...
- Active Record-style schema, scopes, relations, reusable validators, update-aware/default-aware persistence, dirty tracking, in-memory transactions, and opinionated migration plans with safety analysis
